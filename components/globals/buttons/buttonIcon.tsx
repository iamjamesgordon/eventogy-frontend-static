...
type ButtonProps = {
    type: 'grid' | 'list' | 'sliders';
    active?: boolean;
};

export default function ButtonIcon({ type, active }: ButtonProps) {
    let BtnClasses = 'mr-2 ';
    let IconClasses = 'w-auto h-6 ';
    IconClasses = active ? IconClasses + ' fill-eventogy-blue ' : IconClasses;
